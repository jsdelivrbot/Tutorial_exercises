...
public abstract class Employee implements Payable
{
  ...
  //a supertype
  // Not Needed now ----> public abstract double earnings();
  // As we do not implement getPaymentAmount here , class still needs to be declared
  // as abstract as contract is not being filled with Payable interface
